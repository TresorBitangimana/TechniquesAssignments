...
public class ProductionWorker extends Employee {
     ...
     * 
     * @param s
     * @throws InvalidShift when the shift does not equal to the day and night
     *                      shift.
     */
    public void setShift(int s) {
        if (s == DAY_SHIFT) {
            shift = DAY_SHIFT;
        } else if (s == NIGHT_SHIFT) {
            shift = NIGHT_SHIFT;
        }
     ...
     * 
     * @param p
     * @throws InvalidPayRate exception when the pay rate s negative
     */
