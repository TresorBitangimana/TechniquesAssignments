...
public class Employee {
     ...
     * @throws InvalidEmployeeNumber Execption when the emplyee number is not valid.
     */
    ...
    /**
     * toString method, returns a string with the employee name, employeee number
     * and hire date.
     */
    @Override
    ...
    public static void main(String[] args) {
        ...
        System.out.println(employee.isValidEmpNum("8732-D"));
